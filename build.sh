...
pushUpdates() {
  ...
  git commit -m "Update" --author="ImagineKube CI Bot <ik-ci-bot@users.noreply.github.com>"
  injectGithubToken
...
pushRemote() {
  ...
  # git remote add gitee https://$GITEE_USER:$GITEE_TOKEN@gitee.com/imaginekube/helm-charts.git
